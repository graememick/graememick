...
Recently, I developed Tango Atsumare with a small team, an app that uses OCR to allow users to create flashcards from images 🤳 and share them with other users.
See of demo here: 
